...
public class RatingService {
    ...
    public String determineRatingColor(double averageRating) {
        if (averageRating == 0) {
            return "#A9A9A9";
        } else if (averageRating > 0 && averageRating <= 1.0) {
            return "#C70039";
    ...
    public String determineRatingColorForRating(double rating) {
        if (rating == 0) {
            return "#A9A9A9";
